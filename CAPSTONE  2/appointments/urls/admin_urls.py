...
urlpatterns = [
    ...
    path('users/<int:user_id>/coverage/add/', v.coverage_add, name='coverage_add'),
    ...
    path('appointments/<int:pk>/resend-reminder/', v.admin_resend_reminder, name='resend_reminder'),
