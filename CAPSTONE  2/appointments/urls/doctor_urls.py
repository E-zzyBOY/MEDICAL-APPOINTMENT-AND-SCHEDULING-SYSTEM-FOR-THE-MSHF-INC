...
urlpatterns = [
    ...
    path('schedule/mini-calendar/',                 v.schedule_mini_calendar_partial, name='schedule_mini_calendar_partial'),
    ...
    path('schedule/day-popover/',                   v.schedule_day_popover,      name='schedule_day_popover'),
    ...
    path('schedule/settings/',                      v.schedule_settings,         name='schedule_settings'),
    path('schedule/template/add/',                  v.schedule_template_add,     name='schedule_template_add'),
    path('schedule/template/quick-add/',            v.schedule_template_quick_add, name='schedule_template_quick_add'),
    path('schedule/template/<int:pk>/edit/',        v.schedule_template_edit,    name='schedule_template_edit'),
    path('schedule/template/<int:pk>/delete/',      v.schedule_template_delete,  name='schedule_template_delete'),
    path('schedule/template/duplicate/',            v.schedule_template_duplicate, name='schedule_template_duplicate'),
