...
urlpatterns = [
    ...
    path('appointments/book/<int:doctor_id>/who/',         v.book_step3_who,         name='book_step3_who'),
    path('appointments/book/<int:doctor_id>/details/',    v.book_step4_details,     name='book_step4'),
