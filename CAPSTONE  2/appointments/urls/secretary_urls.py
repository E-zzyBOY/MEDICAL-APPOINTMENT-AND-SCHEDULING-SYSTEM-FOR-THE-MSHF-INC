...
urlpatterns = [
    ...
    path('schedules/mini-calendar/',                 v.schedule_mini_calendar_partial, name='schedule_mini_calendar_partial'),
    path('schedules/day/',                           v.schedule_day_panel,        name='schedule_day_panel'),
    path('schedules/day-popover/',                   v.schedule_day_popover,      name='schedule_day_popover'),
