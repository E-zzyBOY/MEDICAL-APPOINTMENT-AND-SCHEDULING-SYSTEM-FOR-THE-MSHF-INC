...
export function BookingPromoBanner({ href }: { href: string }) {
	return (
		<a
			href={href}
			className="animate-fade-up block rounded-2xl bg-gradient-to-br from-[#112E81] via-[#1d3a8f] to-[#4647AE] p-5 text-white relative overflow-hidden"
		...
		>
			...
			<div className="relative max-w-[70%]">
				...
				<span className="inline-flex items-center gap-1.5 text-sm font-medium bg-white text-[#112E81] rounded-lg px-3.5 py-2">
