...
export function BookingPromoBanner({ href }: { href: string }) {
	return (
		<a
			href={href}
			className="animate-fade-up block rounded-2xl bg-gradient-to-br from-[#12300A] via-[#183E0C] to-[#1F4D11] p-5 text-white relative overflow-hidden"
		...
		>
			...
			<div className="relative max-w-[70%]">
				...
				<span className="inline-flex items-center gap-1.5 text-sm font-medium bg-white text-[#081803] rounded-lg px-3.5 py-2">
