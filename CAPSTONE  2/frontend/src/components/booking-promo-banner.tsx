...
export function BookingPromoBanner({ href }: { href: string }) {
	return (
		<a
			href={href}
			className="animate-fade-up block rounded-2xl bg-gradient-to-br from-[#34536A] via-[#416581] to-[#4D7493] p-5 text-white relative overflow-hidden"
		...
		>
			...
			<div className="relative max-w-[70%]">
				...
				<span className="inline-flex items-center gap-1.5 text-sm font-medium bg-white text-[#1F3342] rounded-lg px-3.5 py-2">
